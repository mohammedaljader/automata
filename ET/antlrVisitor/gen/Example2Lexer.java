...
public class Example2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IS_EQUAL", "MUL", "DIV", "ADD", "SUB", "POW", "FACT", "PARANL", "PARANR", 
			"DOT", "ADD_INCREMENT", "SUB_INCREMENT", "INCREMENT", "DECREMENT", "OPEN_CURLY_BRACKET", 
			"CLOSE_CURLY_BRACKET", "AND", "OR", "GREATER_OR_EQUAL", "SMALLER_OR_EQUAL", 
			"GREATHER_THAN", "SMALLER_THAN", "EQUAL", "NOT_EQUAL", "IntType", "BoolType", 
			"StringType", "WHILE", "COMMA", "SEMICOLON", "IF", "ELSE", "FOR", "Print", 
